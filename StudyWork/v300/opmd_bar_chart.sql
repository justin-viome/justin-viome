...
select 
case when nymc_oc_status = 'Positive' then 'OC-OT'
	when nymc_oc_status = 'Unknown' then 'Unknown'
	when (nymc_oc_status='Negative' AND lesions in ('Dysplasia','Hyperplasia','Erythroplakia (abnormal red lesions in your mouth)','Leukoplakia (thick white patches in your mouth and gums)','Lichenoid lesions')) then 'OPMD-M' 
